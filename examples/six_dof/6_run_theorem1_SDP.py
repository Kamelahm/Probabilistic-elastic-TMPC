...
print("\n========== SAVE CHECK ==========")
print(f"Gamma_A max = {Gamma_A.max():.6e}")
print(f"Position rows = {Gamma_A[:n//2].max():.6e}")
print(f"Velocity rows = {Gamma_A[n//2:].max():.6e}")
print(f"h_wtilde max = {h_wtilde.max():.6e}")
print("================================")
with open(p_d / "identified_model.pckl", "wb") as f:
    pickle.dump(identified, f)
print(f"\nSaved -> {p_d / 'identified_model.pckl'}")
print("NEXT: python examples/six_dof/7_run_theorem2_tube.py")